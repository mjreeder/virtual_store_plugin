...
function display_admin_panel()
{
  ...
  <div class="wrapper">
      ...
      <main class="admin">
          ...
          <nav class="sidebar">
              <ul>
          <li <?php echo !isset($_REQUEST['section']) || $_REQUEST['section'] == 'order_history' || $_REQUEST['section'] == 'stats' ? "class='selected-tab'" : ''?>><a href="<?php echo get_site_url().'/wp-admin/admin.php?page=dcvs_teacher&student_id='.$_REQUEST['student_id'] ?>">STUDENT INFO</a></li>
          <li <?php echo (isset($_REQUEST['section']) && $_REQUEST['section'] == 'users') ? "class='selected-tab'" : ''?> ><a href="<?php echo get_site_url().'/wp-admin/admin.php?page=dcvs_teacher&student_id='.$_REQUEST['student_id'].'&section=users' ?>">1. MANAGE STUDENTS</a></li>
				  ...
				  <li <?php echo (isset($_REQUEST['section']) && $_REQUEST['section'] == 'manage') ? "class='selected-tab'" : ''?>><a href="<?php echo get_site_url().'/wp-admin/admin.php?page=dcvs_teacher&student_id='.$_REQUEST['student_id'].'&section=manage' ?>">5. MANAGE CONSUMERS</a></li>
				  <li <?php echo (isset($_REQUEST['section']) && $_REQUEST['section'] == 'assign') ? "class='selected-tab'" : ''?>><a href="<?php echo get_site_url().'/wp-admin/admin.php?page=dcvs_teacher&student_id='.$_REQUEST['student_id'].'&section=assign' ?>">6. ASSIGN CONSUMERS</a></li>
			  </ul>
          </nav>
          <?php
