...
add_action("wp_enqueue_scripts", "dcvs_update_cart_page");
...
function dcvs_update_cart_page(){
    wp_enqueue_script("dcvs_update_woocommerce_cart", plugins_url("/js/update_cart_totals.js", __FILE__), [], false, true);
